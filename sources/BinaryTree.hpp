...
namespace ariel {
    ...
    class BinaryTree {
        ...
        public:
            ...
            BinaryTree<T> search_parent(const T& parent, const T& child, bool isleft) {
                if (root == NULL) {
            ...
            BinaryTree<T> add_left(const T& rootdata, const T& leftdata) {
                search_parent(rootdata, leftdata, true);
                return *this;
            }

            BinaryTree<T> add_right(const T& rootdata, const T& rightdata) {
